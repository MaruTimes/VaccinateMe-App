...
import PayTMQR from './OfflineMerchant.jfif'
...
const promosg = {
  ...
  url: window.location.href.indexOf('localhost') ? 'https://play.google.com/store/apps/details?id=com.vaccinate.me' : window.location.href
}
    ...
    return (
      <div className="App">
        ...
        <header className="App-header">
          <h1>
            Vaccinate ME - automatic vaccine bookings and availability tracking in India
          </h1>
          <p>
